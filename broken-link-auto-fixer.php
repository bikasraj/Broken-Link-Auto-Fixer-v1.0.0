 ...
 * Plugin URI:        https://codesala.in/broken-link-auto-fixer
...
/**
 * Hook into the daily cron event and run an automatic scan.
 */
...
/**
 * Instantiate admin page and AJAX handler on appropriate hooks.
 */
function blaf_init() {
	new BLAF_Admin_Page();
...
function blaf_enqueue_admin_assets( $hook ) {
	...
	if ( strpos( $hook, 'broken-link' ) === false ) {
		return;
	}
